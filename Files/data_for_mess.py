...
- это отсутствие или плохое состояние разметки на проезжей части."""
    ...
    Понял. Тогда вам сфотографировать или нужно записать видео с участием 3-го лица, \
совершающего противоправное действие, и добавить краткое описание
    """,
    "action_description": """
    Хорошо. Теперь напишите пожалуйста краткое описание произошедшего противоправного действия
    """,
    "media_of_illegal_actions": """
    Принял. Осталось только отправить виео или фотопротивоправного действия
    """,
    "dangerous_situation": """
