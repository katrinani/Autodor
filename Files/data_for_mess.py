...
Все, что вы хотели узнать о поездках по федеральным трассам Челябинской и Курганской областей и сообщить дорожникам – здесь. 
Поехали!
    """,
    "attention": """
    ⚠️ Внимание! ⚠️ 
Остановитесь, прежде чем продолжать общение с чат-ботом! Использование телефона за рулем небезопасно!
    """,
    "send_loc": """
...
Единый телефон пожарных и спасателей – 101.
    """,
    "voice_requirements": """
    Понял! Вы можете отправить голосовое сообщение для облегчения взаимодействия с ботом. Попробуйте!  
